...
import fr.perso.nico.config.audit.AuditEventConverter;
import fr.perso.nico.domain.PersistentAuditEvent;
...
import static fr.perso.nico.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
